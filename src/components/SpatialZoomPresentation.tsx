...
const CHAPTERS = [
  ...
  { id: 'cap-2', title: 'التفصيلية', icon: Database, color: 'bg-rose-500', shadow: 'shadow-rose-400/40', startIdx: 17 },
...
const SLIDES = [
  ...
  { 
    ...
    content: 'تعتبر الدراسة التمهيدية حجر الأساس في بناء أي نظام معلوماتي، حيث تهدف إلى فهم معمق للنظام الموجود، تحليل نقاط قوته وضعفه، وتحديد المتطلبات الحقيقية للمستخدمين قبل الشروع في عملية التصميم.', 
    icon: Info, 
  ...
  { 
    ...
    content: 'أكدت الدراسة التحليلية ضرورة الانتقال إلى النظام الآلي كحل حتمي لتجاوز عقبات التسيير التقليدي، مما يمهد الطريق للدراسة التفصيلية لبناء هيكل النظام الجديد.', 
    icon: CheckCircle2, 
  ...
  { 
    id: 'ch2-preface', 
    chapter: 'الدراسة التفصيلية', 
    title: 'تمهيد الفصل الثاني', 
    desc: 'مدخل للنمذجة والتصميم', 
    content: 'بعد الانتهاء من تحليل النظام الموجود، ننتقل في هذا الفصل إلى مرحلة التفصيل، حيث نقوم ببناء النماذج التصورية والمنطقية التي ستشكل الهيكل الأساسي لقاعدة البيانات والعمليات البرمجية للنظام الجديد.', 
    icon: Info, 
    color: 'bg-rose-600' 
  },
  { 
  ...
  { 
    ...
    content: 'نصل في هذا الفصل إلى المرحلة الختامية، حيث نقوم بتحويل النماذج التفصيلية إلى تطبيق فعلي باستخدام أدوات البرمجة وقواعد البيانات، مع استعراض واجهات النظام وإجراءات الحماية.', 
    icon: Info, 
    color: 'bg-amber-600' 
  },
  { 
